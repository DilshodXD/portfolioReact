                ...
                <div class="container">
                    <div class="header__bottom-inner">
                        <div class="header__bottom-left">
                            ...
                            <p class="header__bottom-text">Men web dasturchilik kursida o'qidim va dasturlashning Front-end
                                yo'nalishi bo'yicha bilimlarga ega bo'ldim. Bu yo'nalishni yanada chuqurroq o'rganish uchun
                                o'z ustimda ishlab kelmoqdaman.</p>
                            <Link to="contact" class="header__bottom-contact">Men bilan bog'lanish</Link>
                            <a href="https://github.com/DilshodXD" class="header__bottom-contact">Git hub akaunt</a>
                        </div>
