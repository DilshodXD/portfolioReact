        ...
        <div class="container">
          ...
          <div class="footer__inner">
            <div class="footer__links">
              <Link to="/" class="footer__text">
                Bosh sahifa
              </Link>
              <Link to="/about" class="footer__text">
                Men haqimda
              </Link>
              <Link to="/portfolio" class="footer__text">
                Portfolio
              </Link>
              <Link to="/contact" class="footer__text">
                Aloqa
              </Link>
            </div>
            <div class="footer__contact">
              <p class="footer__text-immutable">Contact:</p>
              <p class="footer__text-immutable">
                Email:{" "}
                <a href="mailto:dilshodxdxd@gmail.com" class="footer__text">
                  dilshodxdxd@gmail.com
                </a>
              </p>
              <p class="footer__text-immutable">
                Inst:{" "}
                <a href="#header" class="footer__text">
                  XD Dilshod
                </a>
              </p>
              <p class="footer__text-immutable">
                Raqam:{" "}
                <a href="tel:+998950186355" class="footer__text">
                  +998 (95) - 018 - 63 -55
                </a>{" "}
              </p>
            </div>
